  ...
  return (
    <section className="grid gap-4 rounded-xl border border-pf-border-default bg-white p-6 shadow-md max-sm:p-4">
      <SurfaceCard tone="default">
        <h2 className="text-[1.2rem] font-semibold">{copy.headline}</h2>
        <p>{copy.supporting}</p>

        <ol className="mt-1 grid gap-2">
          <li className="rounded-md border border-[#dbe5f0] bg-[#f8fbff] px-3 py-2 text-sm">
      ...
      <SurfaceCard tone="default">
        <div className="h-7 w-36 animate-pulse rounded bg-[#dde7f3]" />
        <div className="h-4 w-full animate-pulse rounded bg-[#e8eff8]" />
        <div className="h-4 w-[85%] animate-pulse rounded bg-[#e8eff8]" />
      </SurfaceCard>

      <SurfaceCard tone="default">
        <div className="grid grid-cols-3 gap-2 max-sm:grid-cols-2">
          <div className="h-16 animate-pulse rounded bg-[#e8eff8]" />
          <div className="h-16 animate-pulse rounded bg-[#e8eff8]" />
          <div className="h-16 animate-pulse rounded bg-[#e8eff8]" />
        </div>
      </SurfaceCard>
