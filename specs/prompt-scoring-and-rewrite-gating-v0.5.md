# PromptFire Prompt Scoring and Rewrite Gating Spec v0.5
...
This v0.5 spec behavior must ship behind a new versioned API contract rather than changing the current v1 API contract in place.
...
* `docs/specs/prompt-scoring-and-rewrite-gating-v0.5.md`
...
If you want, I can turn this into a tighter engineering-ready markdown version with explicit JSON response examples.
...
## Engineering-ready contract examples for v0.5
...
I’d keep `rewrite` and `evaluation` as explicitly nullable in `v0.5`, rather than omitted. That makes frontend handling and schema evolution simpler.
...
If you want, I can turn this into a compact markdown section ready to paste into your spec file.
